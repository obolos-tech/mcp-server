...
import { ANP_TYPES, getANPDomain, computeContentHash, usdToUsdc, hashListingIntent as hashListingStruct, hashBidIntent as hashBidStruct } from 'anp-sdk';
    ...
    if (!signer) {
        return {
            content: [
                {
                    type: 'text',
                    text: 'No wallet configured. Set up a wallet using one of these methods:\n\n' +
